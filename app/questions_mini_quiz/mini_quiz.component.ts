...
@Component({
	selector: "mini_quiz",
	moduleId: module.id,
	templateUrl: "./mini_quiz.component.html",
	styleUrls: ['./mini_quiz.component.css']
})
export class MiniQuizComponent implements OnInit {
	...
	navigateToMQScore() {
		...
		this.routerExtensions.navigate(["/score_mq"], navigationExtras);
	}
